package com.cleanarchitect.builder;

import com.cleanarchitect.builder.worker.Director;
import com.cleanarchitect.builder.worker.impl.HTMLBuilder;
import com.cleanarchitect.builder.worker.impl.TextBuilder;
